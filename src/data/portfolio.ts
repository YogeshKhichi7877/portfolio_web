...
export const projects = [
  ...
  { id: 'ai-chat-box', name: 'AI Chat Box', category: 'GEMINI API / FIRST-SEMESTER PROJECT', number: '04', type: 'chat', title: 'One interface. Six ways to explore AI.', description: 'Built in my first semester: a React and TypeScript interface backed by Express and Google’s Gemini SDKs. Six modes bring text, multi-turn conversation, code execution, PDF analysis, reasoning, and structured JSON into one workspace.', detail: 'Mode-specific API routes, conversation context, PDF uploads, schema-based JSON output, and code-result rendering. Theme switching, a 3D backdrop, and animated feedback make the interface part of the engineering.', tech: 'React / TypeScript / Express / Gemini API / Tailwind CSS', url: 'https://github.com/YogeshKhichi7877/AI_chat_box', linkLabel: 'Explore source code', metric: '6', metricLabel: 'purpose-built AI modes' },
